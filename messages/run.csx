    ...
    using (BotService.Initialize())
    {
        ...
        if (activity != null)
        {
            ...
            case ActivityTypes.Message:
                ...
                if (isGroup){
                    string tktN = "6810";
                var skypeJson = await GetSkypeGroup(tktN);
                        ...
                        if (!String.IsNullOrEmpty(skypeJson))
                        {
                            ...
                            if ((string)skypeItem.code == "SUCCESS")
                            {
                                ...
                                replys.Text += "Skype discussion Url  " + joinSkype + "";
                                replys.Text += $"{Environment.NewLine} {Environment.NewLine}";
                                replys.Text += $" --- {Environment.NewLine} {Environment.NewLine}";
                                replys.Text += "Join discussion of Ticket #"+tktN+" by link [**" + joinSkype + "** ](" + joinSkype + ")";
